$(document).ready(function(){
    ...
    createTypedAnimation(".typing-8", ["Experticia en Iniciativa Privada"], 30, 15, 1500, false);
    createTypedAnimation(".typing-9", ["Trayectoria en Función Pública"], 30, 15, 1500, false);
