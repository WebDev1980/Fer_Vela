$(document).ready(function(){
    ...
    createTypedAnimation(".typing-6", ["Fernando Vela"], 50, 30, 900, true);  // Muestra el cursor durante la animación y lo oculta al final
    ...
    createTypedAnimation(".typing-13", ["Legislación Responsable"], 80, 40, 700, false);
    createTypedAnimation(".typing-14", ["Legislando a Irapuato"], 50, 30, 1300, false);
