$(document).ready(function(){
    ...
    createTypedAnimation(".typing-1", ["Fer Vela"], 40, 20, 4800, false);
    createTypedAnimation(".typing-2", ["Diputado Local del Distrito IX"], 20, 10, 6300, false);
    createTypedAnimation(".typing-3", ["por el municipio de Irapuato"], 30, 15, 8000, false);
    ...
    createTypedAnimation(".typing-6", ["Fer Vela"], 50, 30, 900, true);  // Muestra el cursor durante la animación y lo oculta al final
    createTypedAnimation(".typing-7", ["Local del Distrito IX (Irapuato)"], 45, 20,3000, true); 
    ...
    createTypedAnimation(".typing-8", ["Experticia en Iniciativa Privada"], 60, 30, 1500, false);
    createTypedAnimation(".typing-9", ["Trayectoria en Función Pública"], 60, 30, 1500, false);
    ...
    createTypedAnimation(".typing-13", ["El cambio"], 80, 40, 700, false);
    createTypedAnimation(".typing-14", ["Transformando a Irapuato"], 50, 30, 1300, false);
    ...
    createTypedAnimation(".typing-17", ["'El Pueblo'"], 65, 40, 1000, false);
