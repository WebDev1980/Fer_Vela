...
function sharerbox(options) {
	...
	let DefaultsocialNetworks = 'whatsapp, telegram, linkedin';
	...
	// Setting URLs for supported social-media sharing links
		...
		var whatsappURL = `https://wa.me/5214621489648?text=Este%20es%20mi%20whatsapp,%20contáctame`;

		// Reddit sharer hyperlink
		var redditURL = `https://www.reddit.com/submit/?url=${currentUrl}`;

		// LinkedIn sharer hyperlink
		var linkedinURL = `https://www.linkedin.com/in/fernando-vela-pro/?url=${currentUrl}`;
		...
		var telegramURL = `https://t.me/FerVela/url?url=${currentUrl}&text=${customDescription}`;
		...
		//Email
		var sendEmailURL = `mailto:fernando.vela@congresogto.gob.mx?subject=Diputado Vela, me interesa contactarte`;
